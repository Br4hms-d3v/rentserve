...
/** Repository for managing Favor entities. Provides basic CRUD operations and more */
@Repository
public interface FavorRepository extends JpaRepository<Favor, Long> {

  /**
   * The method check if the name of service exist True if the name of favor exist False if then
   * name of favor doesn't exist
   *
