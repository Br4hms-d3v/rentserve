...
/** Repository for managing Material entity. Provides basic CRUD and more */
@Repository
public interface MaterialRepository extends JpaRepository<Material, Long> {

  /**
   * The method check if the name of material exist True if the name of material exist False if then
   * name of material doesn't exist
   *
