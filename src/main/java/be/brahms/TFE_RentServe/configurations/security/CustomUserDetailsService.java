...
/**
 * This class loads user details from the database using the username (pseudo). It is used by Spring
 * Security to check login and roles.
 */
@Service
            ...
            .orElseThrow(
                () ->
                    new UsernameNotFoundException(
                        "L'utilisateur avec le pseudo: " + pseudo + " est introuvable "));

    return new org.springframework.security.core.userdetails.User(
        user.getPseudo(), user.getPassword(), getGrantedAuthorities(user.getRole().toString()));
  }
