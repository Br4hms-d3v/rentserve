...
/**
 * This controller manages Material It has a method to display a list of materials It has a method
 * to display a material by ID It has a method to display a list of materials by category It has a
 * method to create a new material It has a method to update a material It has a method to delete a
 * material
 *
 * @author Brahim K
 */
...
public class MaterialController {
   ...
   * @param materialByIdAssembler the assembler used to convert Material to into MaterialByIdDto
   *     models
   */
  public MaterialController(
      MaterialService materialService,
      MaterialAssembler materialAssembler,
      MaterialByIdAssembler materialByIdAssembler) {
  ...
  @PreAuthorize("hasAnyRole('MEMBER','MODERATOR','ADMIN')")
  public ResponseEntity<CollectionModel<MaterialDTO>> findByCategoryName(
  ...
  public ResponseEntity<EntityModel<MaterialDTO>> createMaterial(
      @RequestBody @Valid MaterialCreateForm form) {
  ...
  @PutMapping("edit/{id}")
  @PreAuthorize("hasAnyRole('MODERATOR','ADMIN')")
  public ResponseEntity<EntityModel<MaterialDTO>> updateMaterial(
      @PathVariable Long id, @RequestBody @Valid MaterialUpdateFormDTO form) {
