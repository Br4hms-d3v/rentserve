...
/**
 * This controller manages Favor It has a method to display a list of favour It has a method to
 * display a details of favor It has a method to create a new favor It has a method to display a
 * list of favour from name of category It has a method to edit a favor It has a method to delete a
 * favor
 *
 * @author Brahim k
 */
...
public class FavorController {
   ...
   * @param favorByIdAssembler the assembler used to convert Favor object to into FavorByIdDto
   *     models
   */
  public FavorController(
      FavorService favorService,
      FavorAssembler favorAssembler,
      FavorByIdAssembler favorByIdAssembler) {
  ...
  @PreAuthorize("hasAnyRole('MEMBER','MODERATOR','ADMIN')")
  public ResponseEntity<CollectionModel<FavorDTO>> getAllFavourByNameCategory(
  ...
  /**
   * This method update some data's about the favor Check if the name of favor already exist
   *
  ...
  @PutMapping("edit/{id}")
  @PreAuthorize("hasAnyRole('MODERATOR','ADMIN')")
  public ResponseEntity<EntityModel<FavorDTO>> updateFavor(
      @PathVariable Long id, @RequestBody @Valid UpdateFavorFormDTO form) {
