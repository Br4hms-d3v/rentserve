...
/**
 * Mapper responsible for converting user entity to various user-related DTOs and updating from form
 * objects.
 *
 * <p>This mapper is used to handle user data transformations between the domain layer and API
 * layer.
 *
 * @author Brahim K
 */
