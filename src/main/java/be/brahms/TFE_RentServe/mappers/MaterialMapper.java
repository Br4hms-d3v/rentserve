...
/**
 * Mapper responsible for converting material entity to various material related DTOs and update
 * from form objects
 *
 * <p>This mapper is used to handle material data transformations between the domain layer and Api
 * layer
 *
 * @author Brahim k
 */
...
public interface MaterialMapper {
  ...
  /**
   * Converts a Material entity to MaterialByIdDto It takes the category name from Material and puts
   * it into the field nameCategory in MaterialByIdDto
   *
  ...
  /**
   * Convert CreateMaterialForm to a material entity. Used when create a material
   *
  ...
  /**
   * Update an existing Material with data from a updateMaterialForm Used when update a material
   *
   * @param form the material form
