...
/**
 * Mapper responsible for converting category entity to various category-related DTOs and updating
 * from form objects
 *
 * <p>This mapper is used to handle category data transformations between the domain layer and Api
 * layer
 *
 * @author Brahim K
 */
...
public interface CategoryMapper {
  ...
  /**
   * Convert a Category entity to a CategoryIdDTO. This DTO contains only the id of the category.
   *
   * @param category the Category entity
  ...
  /**
   * Convert a CategoryForm to a Category entity. Used when creating a new category.
   *
  ...
  /**
   * Update an existing Category entity with data from a CategoryForm. Used when updating a
   * category.
   *
   * @param form the category form
