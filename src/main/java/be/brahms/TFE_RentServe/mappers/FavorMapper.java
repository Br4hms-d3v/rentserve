...
/**
 * Mapper responsible for converting favor entity to various favor related DTOs and updating from
 * form objects
 *
 * <p>This mapper is used to handle favor data transformations between the domain layer and Api
 * layer
 *
 * @author Brahim k
 */
...
public interface FavorMapper {
  ...
  /**
   * Converts a Favor entity to FavorByIdDto It takes the category name from Favor and puts it into
   * the field nameCategory in FavorByIdDto
   *
  ...
  /**
   * Convert CreateFavorForm to a Favor entity. Used when create a favor
   *
  ...
  /**
   * Update an existing Favor entity with data from a UpdateFavorForm. Used when update a favor
   *
   * @param form the favor form
