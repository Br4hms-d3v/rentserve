 ...
 *
 * <p>It contains the HTTP status code, a short error label, and a detailed message. This record
 * helps the frontend show clear error messages to the user.
 *
...
public record ApiError(int status, String error, String message) {
   ...
   * @param message the custom message from the exception or backend (example: "Account not
   *     activated")
