...
/**
 * This exception is thrown when a password is invalid. It is a type of {@link UserException} used
 * to indicate that an operation requiring a password has failed because the password is incorrect.
 *
 * @see UserException
 */
