...
/**
 * UserRoleDto is a data transfer object for role from user It holds user details like name,
 * firstname, role and created
 *
...
public record UserRoleDTO(
    String name, String firstName, String pseudo, Role role, LocalDate createdAt) {}
