...
/**
 * A Dto (Data Transfer Object) for material information It contains simple data about the material
 * and his details
 *
...
public record MaterialByIdDTO(
    Long id, String nameMaterial, String nameCategory, boolean isAvailable) {}
