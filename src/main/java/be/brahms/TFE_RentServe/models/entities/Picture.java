...
/**
 * This class represents a picture and extends the BaseEntity class. It includes the picture's name
 * and its relationships to user-material and user-favor.
 */
@Entity
@Getter
@Setter
...
public class Picture extends BaseEntity {
  /** The name of the picture. This value cannot be null. */
  ...
  /**
   * The user-material relationship to which this picture belongs. A picture is associated with one
   * user-material.
   */
