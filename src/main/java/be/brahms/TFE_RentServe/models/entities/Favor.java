...
/**
 * This class represents a favor (service or item) and extends the BaseEntity class. It includes the
 * favor's name, description, price, and availability, along with its relationships to users and
 * categories.
 */
@Entity
...
public class Favor extends BaseEntity {
  /** The name of the favor. This value cannot be null. */
  @Column(name = "name_favor", nullable = false)
  private String nameFavor;

  /**
   * A flag indicating whether the favor is available or not. The default value is false
  ...
  /**
   * A set of user-favor relationships. This represents which users have chosen this favor. A favor
  ...
  /** The category to which this favor belongs. A favor is associated with one category. */
  // Relation ManyToOne
  @ManyToOne
