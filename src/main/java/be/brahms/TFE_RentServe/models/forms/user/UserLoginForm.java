...
/**
 * This form is used when a user wants to log in. It takes the email or pseudo and the password.
 *
 ...
 */
public record UserLoginForm(@Email String email, String pseudo, @NotBlank String password) {}
