...
/** Service implementation for managing email Import method EmailService */
@Service
public class EmailServiceImpl implements EmailService {
  ...
  /**
   * Send a confirmation email for update if the user doesn't change password. he clicks on the link
   * to update
   *
   * @param to The email to send to.
